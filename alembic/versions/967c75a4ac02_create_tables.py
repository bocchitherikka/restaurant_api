...
Revision ID: 967c75a4ac02
Revises: f49467d9f3e1
Create Date: 2025-04-07 20:33:04.926596
...
revision: str = '967c75a4ac02'
down_revision: Union[str, None] = 'f49467d9f3e1'
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_tables_seats'), 'tables', ['seats'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_tables_seats'), table_name='tables')
